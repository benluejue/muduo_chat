...
-- 将客户端连接的字符集设置为在执行当前语句之前使
-- 用的相同字符集。这样做是为了确保客户端连接字符集不会被语句更改。
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `groupuser`(
  ...
  `grouprole` ENUM('creator', 'normal') CHARACTER SET latin1 DEFAULT 'normal',
...
)ENGINE=InnoDB AUTO_INCREMENT=22 CHARACTER SET=utf8;
